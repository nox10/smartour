package com.smartour.app.views.managepoints;
...
@PageTitle("Manage Points")
@Route(value = "manage", layout = MainLayout.class)
@RolesAllowed("admin")
@Tag("manage-points-view")
@JsModule("./views/managepoints/manage-points-view.ts")
public class ManagePointsView extends LitTemplate implements HasComponents, HasStyle {

    @Id
    private Select<String> sortBy;

    public ManagePointsView() {
        addClassNames("manage-points-view", "flex", "flex-col", "h-full");
