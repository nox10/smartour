package com.smartour.app.views.savedroutes;
...
@AnonymousAllowed
@Tag("saved-routes-view")
@JsModule("./views/savedroutes/saved-routes-view.ts")
public class SavedRoutesView extends LitTemplate implements HasComponents, HasStyle {

    @Id
    private Select<String> sortBy;

    public SavedRoutesView() {
        addClassNames("saved-routes-view", "flex", "flex-col", "h-full");
